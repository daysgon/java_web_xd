        ...
        <div class="lfnav fl">
            ...
            <div class="subddzx">
                <ul>
                    ...
                    <li><a href="/admin/goodslist" style="color:#ff6700;font-weight:bold;">商品管理</a></li>
            ...
            <div class="panel admin-panel">
                ...
                <table class="table table-hover text-center">
                    <tr>
                        ...
                        <th  width="100" style="text-align:left; padding-left:20px;">商品名称</th>
                        <th  width="100" style="text-align:left; padding-left:20px;">商品信息</th>
                        <th  width="100" style="text-align:left; padding-left:20px;">库存</th>
                        <th  width="100" style="text-align:left; padding-left:20px;">价格</th>
                        <th  width="100" style="text-align:left; padding-left:20px;">品类</th>
                    ...
                    <volist name="list" id="vo">
                        <c:forEach items="${allgoods}" var="u">
                        <tr>
                            ...
                            <td><div class="button-group"> <a class="button border-main" href="/admin/updategoodslelist?id=${u.id}"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="/admin/deletegoodslist?id=${u.id}"><span class="icon-trash-o"></span> 删除</a></div></td>
                        </tr>
                        </c:forEach>
                </table>
            </div>
