...
<div class="header bg-main">
    <div class="logo margin-big-left fadein-top">
        <h1><img src="images/y.jpg" class="radius-circle rotate-hover" height="50" alt="" />卖家管理中心</h1>
    </div>
...
<div class="leftnav">
    ...
    <ul style="display:block">
        <li><a href="/sell/info" target="right"><span class="icon-caret-right"></span>用户信息显示</a></li>
        <li><a href="pass.html" target="right"><span class="icon-caret-right"></span>修改密码</a></li>
        <li><a href="/sell/handle" target="right"><span class="icon-caret-right"></span>品类管理</a></li>
